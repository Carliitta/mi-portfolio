...
export default function Portfolio() {
  ...
  const projects = [
    ...
    },
    {
      ...
      tags: ["React Native", "Expo", "MapLibre", "Google Maps"],
    ...
    <div className="bg-white text-black">
      ...
      <nav className="fixed top-0 w-full bg-gray-100 backdrop-blur-md z-50 border-b border-slate-200">
        ...
        {mobileMenuOpen && (
          <div className="md:hidden bg-amber-950/60 border-t border-slate-800 py-4">
            {["inicio", "proyectos","casos", "habilidades", "contacto"].map((item) => (
              <button
                key={item}
                onClick={() => scrollToSection(item)}
      ...
      >
        <div className="max-w-4xl mx-auto text-center">
          <div className="mb-8">
            <div className="w-24 h-24 mx-auto mb-6 rounded-full bg-gradient-to-br from-amber-700/40 to-amber-950/80 p-1">
      ...
      >
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-gray-100 text-center mb-12 max-w-2xl mx-auto">
            Aquí están algunos de mis mejores trabajos. Cada proyecto representa
            mi pasión por crear soluciones elegantes y funcionales.
          </p>
      ...
      <section id="habilidades" className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-gray-500 text-center mb-12 max-w-2xl mx-auto">
            Herramientas y tecnologías que domino para crear aplicaciones de
            alta calidad.
          </p>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {skills.map((skillGroup, idx) => (
              <div
                key={idx}
                className="bg-amber-950/60 p-6 rounded-xl border border-slate-800 hover:border-cyan-400/50 transition"
              >
      ...
      <section id="contacto" className="py-20 px-4 sm:px-6 lg:px-8 bg-gray-100">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <p className="text-amber-950/60 mb-12">
          ...
          <div className="flex gap-6 justify-center mb-12">
            <a
              target="_blank"
              href="mailto:carla.rodriguez340@gmail.com"
            ...
            <a
              ...
              className="flex items-center gap-2 px-6 py-3 text-gray-600 border border-amber-800 hover:bg-amber-950/30 rounded-lg transition"
            >
